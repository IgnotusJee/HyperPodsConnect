...
class ConnectionPresentationGateTest {
    ...
    @Test
    fun `address key remains stable when title settles after Ready`() {
        val first = connectionPresentationKey("sony", "LinkBuds", null, "aa:bb:cc:dd:ee:ff")
        val settled = connectionPresentationKey("sony", "LinkBuds S", null, "AA:BB:CC:DD:EE:FF")
