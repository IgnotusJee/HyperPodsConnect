package org.hyperpods.connect.utils.miuiStrongToast
...
import org.hyperpods.connect.utils.SystemApisUtils.isHyperOS
import org.hyperpods.connect.integration.HeadphoneBatteryPresentation
import org.hyperpods.connect.utils.miuiStrongToast.data.IconParams
import org.hyperpods.connect.utils.miuiStrongToast.data.Left
import org.hyperpods.connect.utils.miuiStrongToast.data.Right
import org.hyperpods.connect.utils.miuiStrongToast.data.StringToastBean
import org.hyperpods.connect.utils.miuiStrongToast.data.TextParams
...
object MiuiStrongToastUtil {
    ...
    fun showStringToast(context: Context, text: String?, colorType: Int) {
        ...
        try {
            ...
            Log.e("HyperPodsConnect", "Failed to show HyperOS String Toast")
        }
    }
    ...
    fun showPodsBatteryToast(
        ...
        try {
            ...
            Log.e("HyperPodsConnect", "Failed to show Pods Battery Toast")
        }
    }
    ...
    fun showPodsBatteryToastByMiuiBt(
        ...
        val intent = Intent("org.hyperpods.connect.action.sendstrongtoast")
        ...
        context.sendIdentitySharedBroadcast(intent)
    }
    ...
    fun showPodsNotificationByMiuiBt(
        ...
        val intent = Intent("org.hyperpods.connect.action.updatepodsnotification")
        intent.putExtra("batteryParams", batteryParams)
    ...
    fun cancelPodsNotificationByMiuiBt(
        ...
        val intent = Intent("org.hyperpods.connect.action.cancelpodsnotification")
        intent.putExtra("device", device)
        intent.`package` = "com.xiaomi.bluetooth"
        context.sendIdentitySharedBroadcast(intent)
    }
