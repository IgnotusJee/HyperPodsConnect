...
import org.hyperpods.connect.config.imageUri
import java.io.File

object PodImageLoader {
    private const val MODULE_PACKAGE = "org.hyperpods.connect"
    ...
    fun loadBitmap(
        ...
        if (custom != null) {
            //android.util.Log.d("HyperPodsConnect-PodImage", "loaded custom $resource for ${earphone?.address}")
            return custom
        }
