package org.hyperpods.connect.ui.components
...
fun AncSwitch(
    ...
    transparencyVocalEnhancementVisible: Boolean = onTransparencyVocalEnhancementChange != null,
    transparencyVocalEnhancementWritable: Boolean = true,
) {
    ...
    Column(
        ...
        if (ancStatus == NoiseControlMode.TRANSPARENCY && transparencyVocalEnhancementVisible) {
            val tabs = listOf(
            ...
            ResponsiveAncTabRow(
                ...
                onTabSelected = {
                    if (enabled && transparencyVocalEnhancementWritable) {
                        onTransparencyVocalEnhancementChange?.invoke(it == 1)
                    }
                },
                compact = compact,
                minWidth = tabMinWidth,
