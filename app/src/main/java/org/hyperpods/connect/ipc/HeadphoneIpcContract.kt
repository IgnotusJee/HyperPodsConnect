...
import moe.chenxy.headphones.core.feature.normalizedAllowedValues
...
object HeadphoneIpcContract {
    ...
    const val MODULE_PACKAGE = "org.hyperpods.connect"
    const val MILINK_PACKAGE = "com.milink.service"
    const val XIAOMI_BLUETOOTH_PACKAGE = "com.xiaomi.bluetooth"
    const val SETTINGS_PACKAGE = "com.android.settings"
    const val ACTION_HEADPHONE_COMMAND = "org.hyperpods.connect.action.HEADPHONE_COMMAND_V3"
    const val ACTION_HEADPHONE_EVENT = "org.hyperpods.connect.action.HEADPHONE_EVENT_V3"
    ...
    companion object {
        fun from(snapshot: HeadphoneSnapshot, hostInstanceId: String): HeadphoneSnapshotPayload {
            ...
            return HeadphoneSnapshotPayload(
                ...
                deviceColorId = state.deviceColorId?.takeIf { mayExposeState },
                ...
                capabilities = profile?.features?.values?.takeIf { mayExposeState }?.map {
                    CapabilityPayload(
                        ...
                        allowedValues = it.normalizedAllowedValues().toList(),
